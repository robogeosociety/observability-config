# Nomad service job supervising the OrbStack `influxdb` container. One file per
...
# (or directly: nomad job run ctl-influxdb.hcl). See supervise.sh for the lifecycle.
variable "supervise" {
  type    = string
