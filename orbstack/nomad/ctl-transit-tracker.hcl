# Nomad service job supervising the OrbStack `transit-tracker` container. One file per
...
# (or directly: nomad job run ctl-transit-tracker.hcl). See supervise.sh for the lifecycle.
variable "supervise" {
  type    = string
