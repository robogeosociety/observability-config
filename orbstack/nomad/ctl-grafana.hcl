# Nomad service job supervising the OrbStack `grafana` container. One file per
...
# (or directly: nomad job run ctl-grafana.hcl). See supervise.sh for the lifecycle.
variable "supervise" {
  type    = string
