...
PY_DIRS=("$GRAFANA/tests" "$GRAFANA/dev-status" "$GRAFANA/claude-usage-collector" "$ROOT/discord-mini-mem" "$GRAFANA/anomaly-detector" "$ROOT/coordination" "$ROOT/influxdb/tests" "$ROOT/orbstack/tests")
